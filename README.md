...
//<!--在20210127日发现程序有大量错误，详细程序见 20210127_GPIO读取输入2.0！！！！！！！！！,已经加入消抖而且换为按下按键灯转换。这个错误就留在这，主要是懒得改hh-->
```
...
通道可在stm32f10x.h里面找到，也可看手册，但手册有误，例如SPI1_IRQChannel应该为SPI1_IRQn
...
```html
<程序参考：20210123(27)_外部中断 23号学，27才写成程序，老懒癌晚期了>
```
